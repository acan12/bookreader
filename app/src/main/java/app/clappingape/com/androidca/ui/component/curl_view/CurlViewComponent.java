package app.clappingape.com.androidca.ui.component.curl_view;
...
public class CurlViewComponent extends GLSurfaceView implements View.OnTouchListener,
     ...
     * Default constructor.
     */
    public CurlViewComponent(Context ctx) {
        super(ctx);
        init(ctx);
    }
     ...
     * Default constructor.
     */
    public CurlViewComponent(Context ctx, AttributeSet attrs) {
        super(ctx, attrs);
        init(ctx);
    }
     ...
     * Default constructor.
     */
    public CurlViewComponent(Context ctx, AttributeSet attrs, int defStyle) {
        this(ctx, attrs);
    }
     ...
     */
    public void setCurrentIndex(int index, Context context) {
